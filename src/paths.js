...
export const CONFIG_DIR = process.env.CLINE_FLEET_CONFIG_DIR || path.join(HOME, ".config", "cline-fleet");
...
export const PROFILES_DIR = process.env.CLINE_FLEET_HOME || path.join(HOME, ".cline-models");
export const ENV_FILE = path.join(PROFILES_DIR, ".env.cline-models");
export const DEFAULT_FLEET_SCRIPT = path.join(HOME, ".local", "bin", "cline-fleet");
